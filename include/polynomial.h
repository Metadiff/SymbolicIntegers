...
template<typename C, typename I, typename P>
bool operator==(const Polynomial <C, I, P> &lhs, const long long int rhs) {
    return (lhs.monomials.size() == 0 and rhs == 0) or (lhs.monomials.size() == 1 and lhs.monomials[0] == rhs);
}

template<typename C, typename I, typename P>
bool operator==(const long long int lhs, const Polynomial <C, I, P> &rhs) {
    return (rhs.monomials.size() == 0 and lhs == 0) or (rhs.monomials.size() == 1 and rhs.monomials[0] == lhs);
}
...
Polynomial <C, I, P> operator+(const Monomial <C, I, P> &lhs, const Monomial <C, I, P> &rhs) {
    ...
    if (up_to_coefficient(lhs, rhs)) {
        if (lhs.coefficient != -rhs.coefficient) {
            result.monomials.push_back(Monomial<C, I, P>(lhs));
...
template<typename C, typename I, typename P>
Polynomial <C, I, P> operator+(const Monomial <C, I, P> &lhs, const long long int rhs) {
...
template<typename C, typename I, typename P>
Polynomial <C, I, P> operator+(const long long int lhs, const Monomial <C, I, P> &rhs) {
    return rhs + lhs;
}
    ...
    while (i1 < lhs.monomials.size() and i2 < rhs.monomials.size()) {
        if (up_to_coefficient(lhs.monomials[i1], rhs.monomials[i2])) {
            if (lhs.monomials[i1].coefficient != -rhs.monomials[i2].coefficient) {
                result.monomials.push_back(Monomial<C, I, P>(lhs.monomials[i1]));
...
template<typename C, typename I, typename P>
Polynomial <C, I, P> operator+(const Polynomial <C, I, P> &lhs, const long long int rhs) {
    return lhs + Polynomial<C, I, P>(rhs);
}

template<typename C, typename I, typename P>
Polynomial <C, I, P> operator+(const long long int lhs, const Polynomial <C, I, P> &rhs) {
    return rhs + lhs;
}
