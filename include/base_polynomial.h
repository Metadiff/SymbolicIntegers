...
#ifndef METADIFF_SYMBOLIC_INTEGERS_SNT_BASE_POLYNOMIAL_H
#define METADIFF_SYMBOLIC_INTEGERS_SNT_BASE_POLYNOMIAL_H
...
#endif //METADIFF_SYMBOLIC_INTEGERS_SNT_BASE_POLYNOMIAL_H
