...
#ifndef METADIFF_SYMBOLIC_INTEGERS_SRT_REGISTRY_IMPL_H
#define METADIFF_SYMBOLIC_INTEGERS_SRT_REGISTRY_IMPL_H
...
#endif //METADIFF_SYMBOLIC_INTEGERS_SRT_REGISTRY_IMPL_H
