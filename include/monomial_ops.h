...
#ifndef METADIFF_SYMBOLIC_INTEGERS_NO_TEMPLATE_REGISTRY_MONOMIAL_OPS_H
#define METADIFF_SYMBOLIC_INTEGERS_NO_TEMPLATE_REGISTRY_MONOMIAL_OPS_H
...
#endif //METADIFF_SYMBOLIC_INTEGERS_NO_TEMPLATE_REGISTRY_MONOMIAL_OPS_H
